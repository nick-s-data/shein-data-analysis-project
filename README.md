...
This project is a complete, production-grade data pipeline that transforms 36,000+ raw, messy SHEIN product records (scraped from Kaggle) across 10 categories into clean, analysis-ready tables and delivers five high-impact, stakeholder-ready business recommendations.
